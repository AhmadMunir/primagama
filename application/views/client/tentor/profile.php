                                        ...
                                        <div class="col-md-4">
                                            <div class="profile-img">
                                              ...
                                              <?php
                                                  ...
                                                  $nama = $raw->nama;
                                                  $id = $raw->id_tentor;
                                                  $id_mapelx = $raw->id_mapel;
                                                  $tmpt = $raw->tempat;
                                                  $tgl = $raw->tanggal_lahir;
                                                  $email = $raw->email;
                                                  $notel = $raw->no_hp;
                                                  $nampel = $raw->nama_mapel;
                                                  ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="profile-head">
                                                ...
                                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="mapel-tab" data-toggle="tab" href="#mapel" role="tab" aria-controls="mapel" aria-selected="false">Mata Pelajaran</a>
                                                    </li>
                                                    <li class="nav-item">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="tab-content profile-tab" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade show" id="mapel" role="tabpanel" aria-labelledby="mapel-tab">
                                                            <div class="row">
                                                                <div class="col-md-6">
